...
export default async function AppHomePage() {
  ...
  return <div className="grid gap-8">
    ...
    <Disclosure title={<><FileJson2 aria-hidden className="size-4 text-muted-foreground"/>Manual import<span className="ml-auto text-xs font-normal text-muted-foreground group-data-[open]/disclosure:hidden">AP2, ACP, or x402</span></>} className="rounded-2xl border border-border bg-card" triggerClassName="p-5" panelClassName="border-t border-border p-5"><IngestForm /></Disclosure>
  </div>;
}
