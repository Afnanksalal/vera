...
const CODE_LABELS: Record<string, string> = { MANDATE_ATTESTATION_MISSING: "Mandate is missing", MANDATE_ATTESTATION_INVALID: "Mandate signature is invalid", MANDATE_OVERSPEND: "Purchase exceeds the mandate", MANDATE_EXPIRED: "Mandate had expired", CART_ATTESTATION_MISSING: "Signed cart is missing", CART_ATTESTATION_INVALID: "Cart signature is invalid", CART_PAYMENT_MISMATCH: "Cart does not match the payment", RECEIPT_ABSENT: "Receipt is missing", RECEIPT_ATTESTATION_INVALID: "Receipt signature is invalid", RETRY_DOUBLE_BOOK: "Possible duplicate payment", SETTLEMENT_ABSENT: "Settlement evidence is missing", SETTLEMENT_DRIFT: "Settlement amount does not match", BANK_CREDIT_ABSENT: "Bank deposit evidence is missing", CHANNEL_UNTAGGED: "Payment channel is not identified", ORPHAN_REFUND: "Refund has no matching payment", DOUBLE_REFUND: "Payment may have been refunded twice" };
